...
<title><? echo title();?> | Upload meme</title>
...
if($upl == 'true')
	{
		...
		$name_img = rand(100000000000000 , 999999999999999);
			...
			$adresar = $_SERVER["DOCUMENT_ROOT"]."/domains/memefaces.me/images/created/"; 
			...
			if($kon == 'png' or $kon == 'jpg' or $kon == 'jpeg' or $kon == 'JPG' or $kon == 'gif')
				...
				if($velikost < 1000000)
					...
					mysql_query("INSERT INTO images VALUES ('','$userid','$title','$descr','$tags','$obrazekk','0','0','0','$date','0')");
					mysql_query("INSERT INTO upload VALUES ('','$userid','$obrazekk')");
					echo'<h2>The file was uploaded!</h2>';
					}
				else
					{
			...
			echo'<form action="upload.php" method="post" id="signupForm" enctype="multipart/form-data">
			  <table width="470" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
				  <td colspan="2"><h2 align="left"><img src="images/uploader.png" alt="Upload" width="54" align="absmiddle"> Upload Your Image or Meme From PC</h2></td>
				</tr>
				<tr>
