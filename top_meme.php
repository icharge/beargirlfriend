...
<title><? echo title();?> | All Meme</title>
...
document.addEventListener('scroll', onScroll);
      ...
      <?
		...
		$url_page_p = $page - 1;
		 ...
		 if($url_page>1){echo'<div class="left_pags"><a href="top_meme.php?page='.$url_page_p.'"></a></div>';}
	 ...
	 $pri = mysql_query("SELECT * FROM images WHERE stav = '1' ORDER BY id DESC LIMIT ".intval($pocet).",$po");
				...
				if($max_stranek > $url_page){echo' <div class="right_pags"><a href="top_meme.php?page='.$url_page.'"></a></div>';}		
		$url_page = $page + 1;
		$url_page_p = $page - 1;
		
		
		echo'<div class="paginge">';
		if($url_page>1){echo'<div class="paginge_left"><a href="top_meme.php?page='.$url_page_p.'"><img src="images/previous.png" alt="previous_meme"></a></div>';}
		if($max_stranek > $url_page){echo'<div class="paginge_right"><a href="top_meme.php?page='.$url_page.'"><img src="images/next.png" alt="next_meme"></a></div>';}
		echo'</div>';
	 ?>
    </div>
  </div>
